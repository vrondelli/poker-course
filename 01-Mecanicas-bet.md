...
1. **Rainbow:** O board não tem nenhum naipe repetido. (Ex: A♠ 7♥ 2♦)
2. **Two-tone (Flush Draw):** Possui 2 cartas do mesmo naipe. (Ex: A♠ 7♠ 2♦)
3. **Monotone:** Todas as cartas do board são do mesmo naipe. (Ex: A♠ 7♠ 2♠)

**Por Pareamento:**

1. **Unpaired:** O board não tem par. (Ex: A♠ 7♥ 2♦)
2. **Paired:** O board tem um par. (Ex: A♠ A♥ 2♦)
3. **Trips:** O board tem 3 cartas do mesmo valor. (Ex: A♠ A♥ A♦)
...
1. **HML Monotone:** (Ex: K♠ 8♠ 3♠)
2. **HML Two-tone:** (Ex: K♠ 8♠ 3♦)
3. **HML Rainbow:** (Ex: K♠ 8♥ 3♦)
4. **HHL Paired:** (Ex: K♠ K♥ 3♦)

**Categorias Gerais (não mutuamente excludentes):**

1. **Dry / Secos:** Boards com poucas possibilidades de draws (Ex: A♠ 7♥ 2♦, K♠ 8♥ 3♦).
2. **Wet / Molhados:** Boards com muitas possibilidades de draws (Ex: 8♠ 7♠ 6♦, Q♠ J♠ 9♦).
3. **Dynamic / Dinâmicos:** Boards onde a carta "nuts" pode mudar frequentemente no turn/river (Ex: 9♠ 8♠ 7♦ - qualquer T, J, 6 ou carta de espadas muda a força relativa das mãos).
4. **Static / Estáticos:** Boards onde o "nuts" dificilmente muda (Ex: A♠ A♥ 7♦,  K♠ 8♠ 3♠).

**Exemplos combinados:**

1. **Seco e Estático:** K♠ 7♥ 2♦ rainbow.
2. **Molhado e Estático:** J♠ 5♠ 2♠ monotone (apesar de molhado por ser monotone, quem tem o flush já tem uma mão muito forte definida).
3. **Molhado e Dinâmico:** 8♠ 7♠ 6♦ two-tone.
4. **Seco e Dinâmico:** A♠ A♥ 8♦ (embora pareça estático, um full house define a mão, mas draws podem não ser tão óbvios). *Nota: Boards pareados geralmente são considerados estáticos, "Seco e Dinâmico" é uma categoria rara, geralmente refere-se a boards rainbow com pouca conectividade mas que cartas altas podem mudar o topo do range.*
...
| :---: | :---: |
| <img src="range-flop-BB(BBxCO-3bet).png" width="400"> | <img src="range-flop-CO(BBxCO-3bet).png" width="400"> |

1. HML rainbow (Ex: K♠ 8♥ 3♦)
2. HML monotone (Ex: K♠ 8♠ 3♠)
3. HML two tone (Ex: K♠ 8♠ 3♦)
4. HHL paired (Ex: K♠ K♥ 3♦)
